    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Delete",
          style: "destructive",
          onPress: () => dispatch(deleteTimeSlot(slotId)),
        },
      ]
    );
  };
      ...
      <ScrollView className="">
        ...
        <View className="bg-blue-500 pt-12 pb-6 px-4">
          ...
          <Text className="text-blue-100 mt-1">
            Set your available appointment slots
          </Text>
        </View>
              ...
              <View className="space-y-4">
                ...
                <View>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setNewSlot((prev) => ({ ...prev, duration: text }))
                    }
                    placeholder="30"
                      ...
                      <View className="flex-row flex-wrap gap-2">
                        {weekDays.map((day) => (
                          <TouchableOpacity
                            key={day}
                            onPress={() =>
                              toggleRecurringDay(day.toLowerCase())
                            }
                          ...
                          >
                            <Text
                              className={`text-xs ${
                                newSlot.recurringDays.includes(
                                  day.toLowerCase()
                                )
                                  ? "text-white"
                                  : "text-gray-700"
