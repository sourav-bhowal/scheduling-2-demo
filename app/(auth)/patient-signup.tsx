  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      console.log(
        ...
        currentState.auth.registeredUsers?.length || 0
      );
      console.log(
        "👥 Registered users:",
      ...
      try {
        if (
          ...
          typeof formData.medicalHistory === "string"
        ) {
